...
<head>
    ...
    <!-- PAGE LEVEL STYLES -->
    <link href="<?php echo BASE_URL?>public/assets/css/layout2.css" rel="stylesheet" />
    <link href="<?php echo BASE_URL?>public/assets/plugins/flot/examples/examples.css" rel="stylesheet" />
    <link href="<?php echo BASE_URL?>public/assets/plugins/timeline/timeline.css" rel="stylesheet" />
    <link href="<?php echo BASE_URL?>public/assets/plugins/dataTables/dataTables.bootstrap.css" rel="stylesheet" />
    ...
    <script src="<?php echo BASE_URL?>public/assets/plugins/dataTables/dataTables.bootstrap.js"></script>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="<?php echo BASE_URL?>index/logout"><i class="icon-signout"></i> Salir </a>
                            </li>
                        </ul>
